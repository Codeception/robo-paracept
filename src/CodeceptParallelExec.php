...
trait CodeceptParallelExec
{
    protected function taskCodeceptParallelExec()
    {
        return new CodeceptParallelExecTask();
    }
}

/**
 * This Task is based on ParallelExec, but adapted for Codeception acceptance testing using phantomjs usage.
 * 
 * Class CodeceptParallelExecTask
 *
 * ``` php
 * <?php
 * $this->taskCodeceptParallelExec()
 ...
 * ```
 */
class CodeceptParallelExecTask extends BaseTask implements CommandInterface, PrintedInterface
{
    use Timer;
